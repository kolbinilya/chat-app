			...
			<div className='flex flex-col items-center justify-center mx-auto max-w-1/3 min-w-96'>
				<div
					...
					<form onSubmit={registerHandler}>
						...
						<select className="select select-info w-full max-w-xs" value={inputs.gender}
										onChange={(e) => setInputs({...inputs, gender: e.target.value})}>
							<option value=''>Select gender</option>
							<option value="male">male</option>
							<option value="female">female</option>
						</select>
						<Link className="link link-hover block mb-4" to='/login'>Already have an account?</Link>
